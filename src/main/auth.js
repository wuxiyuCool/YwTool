...
const WRITE_PATTERN = /:(save|delete|toggle|run|runNow|runScript|exec|execOne|reset|reveal|cleanup|append|lint|loginTest|ack|ackAll|test|password|export|import|chat|generate|optimize|clear|new|switch|open)$/;
